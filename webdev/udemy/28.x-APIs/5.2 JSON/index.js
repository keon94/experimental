...
app.post("/recipe", (req, res) => {
  ...
  recipeJSON.forEach((recipe) => {
    let proteinName = recipe.ingredients.protein.name
    if (proteinName.toLowerCase() === choice.toLowerCase()) {
      ingredients = recipe.ingredients;
    }
  });
  if (ingredients) {
    res.render(getPath("./views/index.ejs"), { ingredients: ingredients });
  } else {
